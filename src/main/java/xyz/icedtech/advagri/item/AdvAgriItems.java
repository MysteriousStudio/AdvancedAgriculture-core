...
public void InitAllItems() {
    ...
    //Plant "Seed"
    RICE_SEED_BAG = AddItemTool();
    CHILI_SEED_BAG = AddItemTool();
    CELERY_SEED_BAG = AddItemTool();
    LETTUCE_SEED_BAG = AddItemTool();
    STRAWBERRY_SEED_BAG = AddItemTool();
    CORN_SEED_BAG = AddItemTool();
    SWEET_POTATO_VINE = AddItemTool();

    //Plant Product
    RICE_UNHUSKED = AddItemTool();
    RICE = AddItemTool();
    PLANT_STRAW = AddItemTool();
    SWEET_POTATO = AddItemTool();
    CHILI = AddItemTool();
    CELERY = AddItemTool();
    LETTUCE = AddItemTool();
    STRAWBERRY = AddItemTool();
    GARLIC = AddItemTool();
    CHUFA = AddItemTool();
